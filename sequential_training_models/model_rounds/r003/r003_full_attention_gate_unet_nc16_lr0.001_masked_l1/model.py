...
decoder gating signals. Drop-in replacement for the standard UNet.

Based on: Attention U-Net (Schlemper et al., 2019)
"""
...
def _gn(ch: int) -> nn.GroupNorm:
    """GroupNorm with the largest valid group count up to 8."""
    g = min(8, ch)
...
class AttentionGateUNet(BaseSurrogate):
    ...
    def __init__(self, depth: int = 7, n_c: int = 32) -> None:
        super().__init__()
