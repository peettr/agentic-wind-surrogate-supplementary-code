...
\author{Auto V4 workflow report}
\address{Graph-DeepONet wind reconstruction campaign notes}
\begin{abstract}
This study documents Phase~9 of the Auto~V4 architecture-search campaign for urban wind-field reconstruction.
...
Phase~9 of the Auto~V4 campaign applied closed-loop, AI-assisted architecture search to the problem of reconstructing urban pedestrian-level wind fields from sparse sensor measurements.
