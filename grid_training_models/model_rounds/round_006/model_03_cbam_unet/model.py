"""Generated standalone Grid model for cbam_unet.
...
def _gn(ch: int) -> nn.GroupNorm:
    ...
    while ch % groups != 0:
        groups -= 1
    return nn.GroupNorm(num_groups=groups, num_channels=ch)
...
class CBAMUNet(BaseSurrogate):
    ...
    Defaults target the smoke20 16GB-tier repair contract at batch=16. The
    original depth=7, n_c=32 default produced roughly 501M parameters and OOMed
    before training.
    """
