# Auto V6 Initial Knowledge Package

## 0. Provenance

- Source session / project: Auto V5, controller_auto11_001 to controller_auto11_020
- Authoring agent: Hermes Agent in the human researcher's Auto V5 workspace
- Date: 2026-05-06 EDT
- Data source: local Auto V5 artifacts under `<LOCAL_HOME_PATH>`
- Any known deviations from Auto V6 contract: This package contains only Auto11 / Auto V5 controller evidence. It does not import any other phase result, ranking, proposal rationale, or report.
- Holdout exclusion rule: this package must contain **no holdout metrics, no holdout rankings, no holdout-derived conclusions, and no candidate selection based on holdout**. Auto V6 initial knowledge may use only training/validation-side evidence from the supplied Auto11 / Auto V5 package. Holdout is reserved for selected/final evaluation only and must not guide planner search.

## 1. Executive summary

- Auto11 covered 20 controller rounds and 200 source candidates from `v5_ai_curated_002`.
...
- The search baseline is `grid18_200ep_baseline` from `auto_v3/campaigns/grid18_200ep/baseline`, with val R2_median 0.708503411.
...
- Validation split size: Auto11 selected candidate val per-case metrics contain 55 val cases.
- Baseline model: `grid18_200ep_baseline`, architecture `unet_v2_baseline`, source `<BASELINE_HPC_SOURCE_ROOT>/campaigns/grid18_200ep/baseline`.
- Baseline metric values:

| split | source | R2_median | R2_mean | R2_global | MAE_median | MAE_mean | n_cases | use |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| val | auto_v5/shared/data/v5_baseline_reference.json | 0.708503411 | 0.622875278 | 0.656619483 | 0.093510993 | 0.085752743 | 55 for Auto11 candidate val metrics; baseline reference stores scalar values | search and benchmark200 screening |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| auto11_003_05_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.734949 | 0.702937 | 0.085048 | 0.749991 | benchmark200_ranked |
| auto11_017_06_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.729361 | 0.709460 | 0.086881 | 0.766345 | benchmark200_ranked |
| auto11_018_04_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.726549 | 0.710891 | 0.084685 | 0.774666 | benchmark200_ranked |
| auto11_011_03_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.721341 | 0.690672 | 0.083326 | 0.749812 | benchmark200_ranked |
| auto11_019_04_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.721115 | 0.700792 | 0.084222 | 0.761668 | benchmark200_ranked |
| auto11_009_04_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.710953 | 0.686029 | 0.087191 | 0.752305 | benchmark200_ranked |
| auto11_019_00_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.708871 | 0.692494 | 0.088401 | 0.725684 | benchmark200_ranked |
| auto11_019_05_unet_v2_baseline | unet_v2_baseline | 34,610,193 (34.6M) | 0.708585 | 0.691738 | 0.087149 | 0.714447 | benchmark200_ranked |
| auto11_004_05_cno_v2 | cno_v2 | 144,933,361 (144.9M) | 0.705373 | 0.684045 | 0.086512 |  | benchmark200_ranked |
| auto11_007_09_dilated_unet | dilated_unet | 14,780,705 (14.8M) | 0.703875 | 0.669857 | 0.088735 |  | benchmark200_ranked |
| auto11_012_06_multiscale_conv | multiscale_conv | 75,159,889 (75.2M) | 0.702762 | 0.687898 | 0.085647 |  | benchmark200_ranked |
| auto11_006_05_cno_v2 | cno_v2 | 144,933,361 (144.9M) | 0.700826 | 0.674971 | 0.090017 |  | benchmark200_ranked |
| auto11_004_02_attention_mamba | attention_mamba | 35,969,713 (36.0M) | 0.696389 | 0.671235 | 0.086492 |  | benchmark200_ranked |
| auto11_002_06_quadmamba | quadmamba | 132,194,421 (132.2M) | 0.696235 | 0.675200 | 0.086326 |  | benchmark200_ranked |
| auto11_020_09_unet_v2_baseline | unet_v2_baseline | 34,610,193 (34.6M) | 0.695249 | 0.683756 | 0.093230 | 0.723541 | benchmark200_ranked |
| auto11_005_02_attention_mamba | attention_mamba | 35,969,713 (36.0M) | 0.692225 | 0.660658 | 0.088225 |  | benchmark200_ranked |
| auto11_014_01_multiscale_conv | multiscale_conv | 75,159,889 (75.2M) | 0.691417 | 0.682706 | 0.087844 |  | benchmark200_ranked |
| auto11_004_08_dilated_fno | dilated_fno | 60,726,001 (60.7M) | 0.691132 | 0.665984 | 0.087023 |  | benchmark200_ranked |
| auto11_019_02_unet_v3 | unet_v3 | 138,432,529 (138.4M) | 0.690247 | 0.675043 | 0.089471 |  | benchmark200_ranked |
| auto11_015_05_sac_unet | sac_unet | 133,726,297 (133.7M) | 0.690088 | 0.670633 | 0.091746 |  | benchmark200_ranked |
| auto11_004_01_attention_gate_unet | attention_gate_unet | 31,467,765 (31.5M) | 0.688523 | 0.661787 | 0.092307 |  | benchmark200_ranked |
| auto11_012_01_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.686502 | 0.653833 | 0.087260 |  | benchmark200_ranked |
| auto11_001_01_attention_mamba | attention_mamba | 35,969,713 (36.0M) | 0.686384 | 0.651668 | 0.092644 |  | benchmark200_ranked |
| auto11_005_05_cno_v2 | cno_v2 | 144,933,361 (144.9M) | 0.685325 | 0.673261 | 0.089400 |  | benchmark200_ranked |
| auto11_018_06_unet_v3 | unet_v3 | 138,432,529 (138.4M) | 0.685211 | 0.673424 | 0.092541 |  | benchmark200_ranked |
| auto11_008_03_dilated_unet | dilated_unet | 14,780,705 (14.8M) | 0.684894 | 0.679513 | 0.091503 |  | benchmark200_ranked |
| auto11_010_04_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.682787 | 0.642210 | 0.088299 |  | benchmark200_ranked |
| auto11_003_09_attention_gate_unet | attention_gate_unet | 31,467,765 (31.5M) | 0.681540 | 0.667969 | 0.092386 |  | benchmark200_ranked |
| auto11_003_06_unet_v3 | unet_v3 | 138,432,529 (138.4M) | 0.680521 | 0.690057 | 0.089692 |  | benchmark200_ranked |
| auto11_010_00_dilated_unet | dilated_unet | 14,780,705 (14.8M) | 0.678897 | 0.691298 | 0.089102 |  | benchmark200_ranked |
...
- Best model_id: auto11_003_05_unet_sdf_7level
...
- Suggested Auto V6 action: exploit

### fourier_unet

- Best model_id: auto11_011_03_fourier_unet
...
- Confidence level: high
- Suggested Auto V6 action: exploit / ablate

### unet_v2_baseline

- Best model_id: auto11_019_05_unet_v2_baseline
...
- Confidence level: high
- Suggested Auto V6 action: control

### cno_v2

- Best model_id: auto11_004_05_cno_v2
...
- Suggested Auto V6 action: ablate / control

### dilated_unet

- Best model_id: auto11_007_09_dilated_unet
...
- Best model_id: auto11_012_06_multiscale_conv
...
- Best model_id: auto11_004_02_attention_mamba
...
- Best model_id: auto11_002_06_quadmamba
...
- Confidence level: high
- Suggested Auto V6 action: avoid unless scaled down

### dilated_fno

- Best model_id: auto11_004_08_dilated_fno
...
- Best model_id: auto11_019_02_unet_v3
...
- Confidence level: medium
- Suggested Auto V6 action: explore further / control

### sac_unet

- Best model_id: auto11_015_05_sac_unet
...
- Best model_id: auto11_004_01_attention_gate_unet
...
- Confidence level: medium
- Suggested Auto V6 action: control / low-priority ablate

### umamba

- Best model_id: auto11_018_02_umamba
...
- Best model_id: auto11_005_09_dilated_hrformer
...
- Best model_id: auto11_008_08_hrdcn
...
- Best model_id: auto11_009_07_hrnet
...
- Best model_id: auto11_006_03_cbam_unet
...
- Best model_id: auto11_007_06_dcn_unet
...
- Best model_id: auto11_002_07_residual_spectral
...
- Best model_id: auto11_016_02_sac_mamba
...
- Best model_id: auto11_013_01_mamba_attention
...
- Best model_id: auto11_010_03_fno_encoder_decoder
...
- Best model_id: auto11_002_09_swin_unetr
...
- What seems to work: no clear positive signal in current Auto11 evidence.
- What seems not to work: low val R2_median or unstable behavior relative to baseline.
- Confidence level: medium
- Suggested Auto V6 action: avoid

### ffno

- Best model_id: auto11_008_04_ffno
...
- Best model_id: auto11_017_01_transolver
...
- Best model_id: auto11_010_08_kan_unet
...
- Best model_id: auto11_006_06_convnext_v2_unet
...
- Best model_id: auto11_008_05_fno2d
...
- Best model_id: auto11_017_09_uno
...
- Best model_id: auto11_001_00_afno
...
- Best model_id: auto11_012_07_nafnet
...
- Best model_id: auto11_013_04_perceiver_io
...
- Best model_id: auto11_015_08_transolver_lite
...
- Best model_id: auto11_001_02_cnn_deeponet
...
- Claim: A 7-level UNet with SDF mechanism is the strongest Auto V6 seed family among Auto11 evidence.
- Proposed Auto V6 test: run 3 to 5 SDF-UNet variants below 150M params with matched training protocol.
...
- Proposed Auto V6 test: run multiple Fourier-UNet seeds/configs with the same data split and 200ep screening protocol.
...
- Claim: Auto V6 should not rely only on val R2_median when a candidate has strong R2_global or MAE signals.
- Proposed Auto V6 test: add a secondary selection gate using R2_global and MAE_median for a small number of candidates.
...
- Claim: Current Mamba2D, UFNO, HRFormer, and Unet-AFNO variants should not be repeated in Auto V6 without down-scaling.
...
- Proposed Auto V6 test: only generate compact variants with preflight parameter estimates below 150M.
...
- Claim: `unet_v2_baseline` should stay as an Auto V6 control, not as the main exploit family.
- Proposed Auto V6 test: include one baseline-compatible control per batch or phase.
- Paired comparison / control: compare every exploit candidate to `grid18_200ep_baseline` and an in-campaign `unet_v2_baseline` control.
- Decision rule: exploit family must beat both the stored grid18 baseline and contemporaneous control.
...
| --- | --- | --- | --- | --- | --- | --- |
| 3 | control | UNet v2 baseline | grid18-compatible unet_v2_baseline, n_c=16, 200ep | grid18 baseline source | stable reference family and direct baseline continuity | do not present as new performance claim |
...
- Known codegen pitfalls: Auto V5 repair policy should stay AI-only and generated-file scoped. Do not repair shared training code from a model generation failure unless explicitly authorized.
- Required helper modules: generated standalone model wrappers under `generated_models/v5_controller_auto11_*/`. Auto V6 should copy or inspect the specific wrappers for candidates it reuses.
- Models requiring special input features: `unet_sdf_7level` includes the SDF mechanism in its generated wrapper and should be reviewed before reusing the same data interface. Other rows record standard Auto V5 gridded inputs with architecture-specific processing inside wrappers.
...
- logs:
  - `<LOCAL_HOME_PATH>` through `<LOCAL_HOME_PATH>`
- metrics folders:
  - controller final rankings under `reports/controller_auto11_*/final_ranking.json`
...
- Any overlapping architecture names with Phase9 are included only because they appear in the separate Auto V5 controller_auto11_001 to controller_auto11_020 source session, not because of Phase9 performance.

## Appendix A. Highest ranked benchmark200 rows

| model_id | arch | params | val_R2_median | val_R2_global | val_MAE_median | round | rank |
| --- | --- | --- | --- | --- | --- | --- | --- |
| auto11_003_05_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.734949 | 0.702937 | 0.085048 | 3 | 1 |
| auto11_017_06_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.729361 | 0.709460 | 0.086881 | 17 | 1 |
| auto11_018_04_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.726549 | 0.710891 | 0.084685 | 18 | 1 |
| auto11_011_03_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.721341 | 0.690672 | 0.083326 | 11 | 1 |
| auto11_019_04_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.721115 | 0.700792 | 0.084222 | 19 | 1 |
| auto11_009_04_fourier_unet | fourier_unet | 34,201,393 (34.2M) | 0.710953 | 0.686029 | 0.087191 | 9 | 1 |
| auto11_019_00_unet_sdf_7level | unet_sdf_7level | 125,771,905 (125.8M) | 0.708871 | 0.692494 | 0.088401 | 19 | 2 |
| auto11_019_05_unet_v2_baseline | unet_v2_baseline | 34,610,193 (34.6M) | 0.708585 | 0.691738 | 0.087149 | 19 | 3 |
| auto11_004_05_cno_v2 | cno_v2 | 144,933,361 (144.9M) | 0.705373 | 0.684045 | 0.086512 | 4 | 1 |
| auto11_007_09_dilated_unet | dilated_unet | 14,780,705 (14.8M) | 0.703875 | 0.669857 | 0.088735 | 7 | 1 |
| auto11_012_06_multiscale_conv | multiscale_conv | 75,159,889 (75.2M) | 0.702762 | 0.687898 | 0.085647 | 12 | 1 |
| auto11_006_05_cno_v2 | cno_v2 | 144,933,361 (144.9M) | 0.700826 | 0.674971 | 0.090017 | 6 | 1 |
