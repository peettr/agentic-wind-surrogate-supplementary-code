"""V4 Codegen â€” Model architecture code generation pipeline.
...
V4 rule: codegen reads ONLY model_specs.yaml, never V3 model source files.
"""
...
def generate_model(
    ...
    if success:
        # Add header comment
        header = (
            f"# Auto-generated by V4 codegen\n"
            f"# Model: {arch_name}\n"
            f"# Category: {spec.get('category', 'unknown')}\n"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="V4 Model Codegen")
